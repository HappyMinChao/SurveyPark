										...
										<tr>
											...
											<td>
												...
												<s:if test="questionType == 3">
													<s:a namespace="/Guest" action="StatisticsAction_showMainTextList?questionId=%{questionId}">以文本列表形式查看简答题的统计结果</s:a>
												</s:if>
												<s:if test="questionType == 4 || questionType == 5">
													<s:a namespace="/Guest" action="StatisticsAction_showMatrixNomalPage?questionId=%{questionId}">查看矩阵式问题的统计结果</s:a>
												</s:if>
												<s:if test="questionType == 6">
													<s:a namespace="/Guest" action="StatisticsAction_showMatrixOptionPage?questionId=%{questionId}">查看矩阵式问题的统计结果</s:a>
												</s:if>
											</td>
										</tr>
